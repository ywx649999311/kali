...
class epoch(object):
    ...
    def __repr__(self):
        ...
        """
        return "libcarma.epoch(%f, %f, %f, %f, %f)"%(self.t, self.x, self.y, self.yerr, self.mask)
...
class lc(object, metaclass=abc.ABCMeta):
    ...
    def __repr__(self):
        ...
        """
        return "libcarma.lc(%d, %f, %s, %s, %s, %s, %f, %f, %f, %f, %f, %f)"%(self._numCadences, self._dt,
    ...
    def fold(self, foldPeriod, tStart=None):
        ...
        sortedLists = list(zip(*sorted(list(zip(tList, xList, yList, yerrList, maskList)), key=operator.itemgetter(0))))
